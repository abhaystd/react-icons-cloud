...
export const ResAmazonEventBridgeSchemaRegistry48: IconType = React.forwardRef<
  SVGSVGElement,
  IconBaseProps
>(({ color, ...props }, ref) => (
...
ResAmazonEventBridgeSchemaRegistry48.displayName =
  "ResAmazonEventBridgeSchemaRegistry48";
