...
export const ResAWSSystemsManagerPatchManager48: IconType = React.forwardRef<
  SVGSVGElement,
  IconBaseProps
>(({ color, ...props }, ref) => (
...
ResAWSSystemsManagerPatchManager48.displayName =
  "ResAWSSystemsManagerPatchManager48";
