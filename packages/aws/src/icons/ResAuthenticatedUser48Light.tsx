...
export const ResAuthenticatedUser48Light: IconType = React.forwardRef<
  SVGSVGElement,
  IconBaseProps
>(({ color, ...props }, ref) => (
  <IconBase ref={ref} viewBox="0 0 48 48" color={color} {...props}>
    <title>
      Icon-Resource/General-Resource/Res_Authenticated-User_48_Light
    </title>
    <path
...
ResAuthenticatedUser48Light.displayName = "ResAuthenticatedUser48Light";
