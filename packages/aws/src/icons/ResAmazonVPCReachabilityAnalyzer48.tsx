...
export const ResAmazonVPCReachabilityAnalyzer48: IconType = React.forwardRef<
  SVGSVGElement,
  IconBaseProps
>(({ color, ...props }, ref) => (
...
ResAmazonVPCReachabilityAnalyzer48.displayName =
  "ResAmazonVPCReachabilityAnalyzer48";
