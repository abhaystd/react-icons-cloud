...
export const ResAWSIoTSiteWiseAssetHierarchy48: IconType = React.forwardRef<
  SVGSVGElement,
  IconBaseProps
>(({ color, ...props }, ref) => (
...
ResAWSIoTSiteWiseAssetHierarchy48.displayName =
  "ResAWSIoTSiteWiseAssetHierarchy48";
