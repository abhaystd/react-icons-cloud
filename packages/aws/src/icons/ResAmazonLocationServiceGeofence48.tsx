...
export const ResAmazonLocationServiceGeofence48: IconType = React.forwardRef<
  SVGSVGElement,
  IconBaseProps
>(({ color, ...props }, ref) => (
...
ResAmazonLocationServiceGeofence48.displayName =
  "ResAmazonLocationServiceGeofence48";
