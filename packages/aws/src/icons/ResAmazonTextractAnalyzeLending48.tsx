...
export const ResAmazonTextractAnalyzeLending48: IconType = React.forwardRef<
  SVGSVGElement,
  IconBaseProps
>(({ color, ...props }, ref) => (
...
ResAmazonTextractAnalyzeLending48.displayName =
  "ResAmazonTextractAnalyzeLending48";
