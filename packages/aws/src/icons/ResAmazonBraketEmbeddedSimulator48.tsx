...
export const ResAmazonBraketEmbeddedSimulator48: IconType = React.forwardRef<
  SVGSVGElement,
  IconBaseProps
>(({ color, ...props }, ref) => (
...
ResAmazonBraketEmbeddedSimulator48.displayName =
  "ResAmazonBraketEmbeddedSimulator48";
