...
export const ResAmazonCloudWatchEventTimeBased48: IconType = React.forwardRef<
  SVGSVGElement,
  IconBaseProps
>(({ color, ...props }, ref) => (
...
ResAmazonCloudWatchEventTimeBased48.displayName =
  "ResAmazonCloudWatchEventTimeBased48";
