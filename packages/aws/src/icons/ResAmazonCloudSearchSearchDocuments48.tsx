...
export const ResAmazonCloudSearchSearchDocuments48: IconType = React.forwardRef<
  SVGSVGElement,
  IconBaseProps
>(({ color, ...props }, ref) => (
...
ResAmazonCloudSearchSearchDocuments48.displayName =
  "ResAmazonCloudSearchSearchDocuments48";
