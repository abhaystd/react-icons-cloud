...
export const ResAmazonVPCElasticNetworkAdapter48: IconType = React.forwardRef<
  SVGSVGElement,
  IconBaseProps
>(({ color, ...props }, ref) => (
...
ResAmazonVPCElasticNetworkAdapter48.displayName =
  "ResAmazonVPCElasticNetworkAdapter48";
