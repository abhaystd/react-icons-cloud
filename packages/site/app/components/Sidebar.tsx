...
export const Sidebar = () => {
    return (
        <aside className="w-64 h-screen fixed left-0 top-0 border-r border-gray-200 bg-white dark:bg-zinc-900 dark:border-zinc-800 p-4 flex flex-col">
            ...
            <nav className="mt-auto pt-4 pb-2 border-t border-gray-100 dark:border-zinc-800 space-y-1">
                <h2 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">
                    Information
                </h2>
                <Link
